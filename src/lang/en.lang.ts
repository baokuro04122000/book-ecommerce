export default {
  ...
  register_is_success:
    'Your account is created, please check the email to active your account',
  server_wrong: 'server something wrong, please contact with admin',
  register_success:
    'register is success, please check your email to active account',
  ...
  register_seller_send_mail:
    'An email sent to your mailbox, please check it to register the seller',
  ...
  send_otp_register_again:
    'OTP is sent to your mail again, please check your mail',
